...
class AlumnoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $sentencia = "SELECT a.Nombre as actividad, b.Nota FROM Actividad a, Alumno_Actividad b WHERE a.id_clase =".$idcurso." AND b.id_actividad = a.id_actividad AND b.id =".$id2.";";
