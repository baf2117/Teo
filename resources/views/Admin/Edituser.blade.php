        ...
        <div class="container-fluid">              
             ...
             <div class="row">
                <div class="col-6  align-items-center">
                    <div class="card">
                        <form class="form-horizontal" id="infop" name="infop" method="POST" action="{{ route('user.edit2') }}" >
                            <div class="card-body">
                        ...
                        <div style="display: none">
                            <form id="eliminar" name="eliminar" method="POST" action="{{ route('user.eliminar') }}" >
                        ...
                        <div style="display: none">
                            <form id="madeaux" name="madeaux" method="POST" action="{{ route('user.upgrade') }}" >
                                <input type="text" hidden="true" class="form-control" readonly="true" name="nombre" id="nombre" value="<?php echo $actual->nombre;?>">
                                <input type="text" hidden="true" class="form-control" readonly="true" name="id" id="id" value="<?php echo $actual->id;?>">
                                {{ csrf_field() }}
                            </form>
                        ...
                        <div class="border-top">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="card-body">
                                        <button type="button" class="btn btn-info" onclick="haceraux()">Auxiliar</button>
                                    </div>                                    
                                </div>
                            </div>
                        </div>
