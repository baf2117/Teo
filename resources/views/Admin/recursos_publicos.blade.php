 ...
 <div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title"> Recursos Públicos </h4>
        </div>
    </div>
</div> 
...
<div style="display: none">
    <form id="descarga" name="descarga" method="POST" action="{{ route('admin.descargar') }}">
        <input type="text" name="idrecurso" id="idrecurso">
        {{ csrf_field() }}
    </form>

    <form id="eliminarRecurso" name="eliminarRecurso" method="POST" action="{{ route('admin.eliminarRecurso') }}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.guardarrecurso') }}" enctype="multipart/form-data">
                    <input type="hidden" name="idcurso" value="null">
...
<script>
    ...
    function eliminar(idrecurso, tipoRecurso){
        var padre = document.getElementById("eliminarRecurso");
        ...
        document.eliminarRecurso.submit();
    }
    ...
    for ($i = 0; $i <count($recursos); $i++) 
    {
        ...
        if($recursos[$i]->Tipo==0){
            ...
            \"<button onclick=\\\"eliminar('".$recursos[$i]->NombreArchivo."','".$recursos[$i]->Tipo."')\\\" data-toggle=\\\"modal\\\" class=\\\"btn btn-danger btn-block waves-effect waves-light\\\"><i class=\\\"mdi mdi-delete\\\"></i> Eliminar</button>\",
