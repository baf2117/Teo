                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        ?>
                            <li class="nav-item dropdown my-auto"> 
                                <a class="nav-link text-muted waves-effect waves-dark pro-pic dropdown-toggle" role="button" href="#" id="adminMenu" aria-expanded="false" aria-haspopup="true" data-toggle="dropdown"  title="Gestionar">
                                ...
                                <div class="dropdown-menu bg-dark text-light border border-dark" aria-labelledby="adminMenu">
                                    ...
                                    <div class="dropdown-menu bg-dark text-light border border-dark" aria-labelledby="examenesMenu">
                                        <a class="dropdown-item bg-dark text-light" href="/admin/carga_examenes">Examen Final</a>
